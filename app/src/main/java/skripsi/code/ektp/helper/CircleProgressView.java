...
public class CircleProgressView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        setDefaultValues();
        TypedArray typedArray = context.getTheme().obtainStyledAttributes(attrs,skripsi.code.ektp.R.styleable.CircularProgressView, 0, 0);

        try {
            mProgress = typedArray.getFloat(skripsi.code.ektp.R.styleable.CircularProgressView_cpv_progress, mProgress);
            mCircleWidth = typedArray.getDimension(skripsi.code.ektp.R.styleable.CircularProgressView_cpv_circle_width, mCircleWidth);
            backgroundStrokeWidth = typedArray.getDimension(skripsi.code.ektp.R.styleable.CircularProgressView_cpv_background_circle_width, backgroundStrokeWidth);
            mCircleColor = typedArray.getInt(skripsi.code.ektp.R.styleable.CircularProgressView_cpv_circle_color, mCircleColor);
            mBackgroundColor = typedArray.getInt(skripsi.code.ektp.R.styleable.CircularProgressView_cpv_background_circle_color, mBackgroundColor);
            mTextColor = typedArray.getInt(skripsi.code.ektp.R.styleable.CircularProgressView_cpv_text_color, mTextColor);
            mTextSize = typedArray.getInt(skripsi.code.ektp.R.styleable.CircularProgressView_cpv_text_size, mTextSize);
            mTextPrefix = typedArray.getString(skripsi.code.ektp.R.styleable.CircularProgressView_cpv_text_prefix);
        } finally {
            typedArray.recycle();
        }
    ...
    private void setDefaultValues() {
        mProgress = 0;
        mCircleWidth = getResources().getDimension(skripsi.code.ektp.R.dimen.default_circle_width);
        backgroundStrokeWidth = getResources().getDimension(skripsi.code.ektp.R.dimen.default_circle_background_width);
