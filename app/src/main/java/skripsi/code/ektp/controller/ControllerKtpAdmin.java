...
public class ControllerKtpAdmin {
    ...
    public ControllerKtpAdmin(Context c, String url, SwipeRefreshLayout lst) {
        this.mContext= c;
        this.urlKtp = url;
        this.list = lst;
    }

    public void setAdapter(KtpAdminListAdapter adt){
        this.adapters=adt;
    }
    public KtpAdminListAdapter getAdapter(){
        return adapters;
    }

    public void getListKtpAdminAll(final String idp, final String role){

        getList().clear();
        list.setRefreshing(true);
        String url = urlKtp +idp+"/role_admin/"+role+"/limit/"+limit;
        idpNode=idp;
    ...
    public void getListKtpAdminCacheAll(final String idp, final String role) {
