...
public class PetugasDB extends SQLiteOpenHelper {
	...
	private static final String TABLE_USER = "user_petugas";
	...
	public PetugasDB(Context context) {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String CREATE_PETUGAS_TABLE = "CREATE TABLE " + TABLE_USER + "("
	...
	public HashMap<String, String> getUserDetails() {
		...
		if (cursor.getCount() > 0) {
			...
			user.put(kode_petugas, cursor.getString(8));
			user.put(img, cursor.getString(9));
			user.put(img_thumb, cursor.getString(10));
			user.put(tanggal_post, cursor.getString(11));
			user.put(status_data, cursor.getString(12));
			user.put(license, cursor.getString(13));
			user.put(provinsi, cursor.getString(14));
			user.put(kabupaten, cursor.getString(15));
			user.put(path, cursor.getString(16));
		}
		cursor.close();
		db.close();
