...
public class AddKtpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_ktp_main);

        db = new PetugasDB(AddKtpActivity.this);
        HashMap<String, String> user = db.getUserDetails();
        id_petugas = user.get(id_petugas_db);
        id_admin = user.get(id_admin_db);
        nama_petugas = user.get(nama_petugas_db);

        cKtp = new ControllerKtpPetugas(AddKtpActivity.this,UrlConfig.URL_ADD_KTP,null);

        cPekerjaan = new ControllerPekerjaan(AddKtpActivity.this, UrlConfig.URL_GET_PEKERJAAN);

        cProvinsi = new ControllerWilayahProvinsi(AddKtpActivity.this, UrlConfig.URL_GET_PROVINSI);
        cProvinsiPengurus = new ControllerWilayahProvinsi(AddKtpActivity.this, UrlConfig.URL_GET_PROVINSI);

        agama_adapter = new ArrayAdapter<String>(AddKtpActivity.this, R.layout.list_dropdown, listAgama);
        gol_darah_adapter = new ArrayAdapter<String>(AddKtpActivity.this, R.layout.list_dropdown, listGolonganDarah);
        kategori_pengurus_adapter = new ArrayAdapter<String>(AddKtpActivity.this, R.layout.list_dropdown, listKategoriPengurus);
        anggota_pengurus_adapter = new ArrayAdapter<String>(AddKtpActivity.this, R.layout.list_dropdown, listAnggotaPengurus);
        pendidikan_terakhir_adapter = new ArrayAdapter<String>(AddKtpActivity.this, R.layout.list_dropdown, listPendidikanTerakhir);

        pekerjaan_anggota_adapter = new ArrayAdapter<String>(AddKtpActivity.this, R.layout.list_dropdown, cPekerjaan.getList());

        provinsi_adapter = new ArrayAdapter<String>(AddKtpActivity.this, R.layout.list_dropdown, cProvinsi.getList());
        provinsi_pengurus_adapter= new ArrayAdapter<String>(AddKtpActivity.this, R.layout.list_dropdown, cProvinsiPengurus.getList());

        pDialog = new ProgressDialog(this);
        pDialog.setCancelable(false);

        Intent intent = getIntent();
        final String stat = intent.getStringExtra("stat");
        final String idp = intent.getStringExtra("idp");
        final String idr = intent.getStringExtra("idr");
        ...
        tgl_lahir_picker = new DatePickerFragment(AddKtpActivity.this, R.id.tanggal_lahir);
        ...
        provinsi.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                if(position>=0){
                    ...
                    cKabupaten = new ControllerWilayahKabupaten(AddKtpActivity.this, UrlConfig.URL_GET_KABUPATEN + id_provinsi_asal);
                    kabupaten_adapter = new ArrayAdapter<String>(AddKtpActivity.this, R.layout.list_dropdown, cKabupaten.getList());
        ...
        kabupaten.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                if(position>=0){
                    ...
                    cKecamatan = new ControllerWilayahKecamatan(AddKtpActivity.this, UrlConfig.URL_GET_KECAMATAN + id_provinsi_asal + "/id_kabupaten/" + id_kabupaten_asal);
                    kecamatan_adapter = new ArrayAdapter<String>(AddKtpActivity.this, R.layout.list_dropdown, cKecamatan.getList());
        ...
        kecamatan.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                if(position>=0){
                    ...
                    cKelurahan = new ControllerWilayahKelurahan(AddKtpActivity.this, UrlConfig.URL_GET_KELURAHAN + id_provinsi_asal + "/id_kabupaten/" + id_kabupaten_asal + "/id_kecamatan/" + id_kecamatan_asal);
                    kelurahan_adapter = new ArrayAdapter<String>(AddKtpActivity.this, R.layout.list_dropdown, cKelurahan.getList());
        ...
        provinsi_pengurus.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                if(position>=0){
                    ...
                    cKabupatenPengurus = new ControllerWilayahKabupaten(AddKtpActivity.this, UrlConfig.URL_GET_KABUPATEN + id_provinsi_pengurus);
                    kabupaten_pengurus_adapter = new ArrayAdapter<String>(AddKtpActivity.this, R.layout.list_dropdown, cKabupatenPengurus.getList());
        ...
        kabupaten_pengurus.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                if(position>=0){
                    ...
                    cKecamatanPengurus = new ControllerWilayahKecamatan(AddKtpActivity.this, UrlConfig.URL_GET_KECAMATAN + id_provinsi_pengurus + "/id_kabupaten/" + id_kabupaten_pengurus);
                    kecamatan_pengurus_adapter = new ArrayAdapter<String>(AddKtpActivity.this, R.layout.list_dropdown, cKecamatanPengurus.getList());
        ...
        kecamatan_pengurus.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                if(position>=0){
                    ...
                    cKelurahanPengurus = new ControllerWilayahKelurahan(AddKtpActivity.this, UrlConfig.URL_GET_KELURAHAN + id_provinsi_pengurus + "/id_kabupaten/" + id_kabupaten_pengurus + "/id_kecamatan/" + id_kecamatan_pengurus);
                    kelurahan_pengurus_adapter = new ArrayAdapter<String>(AddKtpActivity.this, R.layout.list_dropdown, cKelurahanPengurus.getList());
        ...
        saveData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(checkForm()){
                    if(isNetworkAvailable(AddKtpActivity.this)) {
                        saveData();
                        Intent addIntent = new Intent(AddKtpActivity.this, ListKtpPetugasFragment.class);
                        setResult(REQUEST_OK, addIntent);
                        finish();
                    } else {
                        Toast.makeText(AddKtpActivity.this, "No internet connection", Toast.LENGTH_SHORT).show();
                    }
                } else {
    ...
    private boolean checkForm() {
        ...
        if (imgPasFotoID.getText().toString().trim().isEmpty()) {
        ...
        if (imgPathID.getText().toString().trim().isEmpty()) {
